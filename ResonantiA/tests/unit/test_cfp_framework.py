import pytest
import numpy as np
from ArchE.cfp_framework import CFPFramework
...
def cfp_default_instance():
    # Initialize without quantum system_configs for testing classical/general methods
    return CFPFramework(config_override={'log_level': 'ERROR'}) 
