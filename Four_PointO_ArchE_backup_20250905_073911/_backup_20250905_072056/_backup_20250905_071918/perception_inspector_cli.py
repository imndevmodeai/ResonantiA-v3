...
def inspector():
    """
    An interactive CLI tool to help developers find the correct selectors
    and generate configuration for the perception knowledge base.
    """
    print("--- Perception Engine Inspector CLI ---")
    ...
    try:
        ...
        # Always run headed for inspection
        ...
        while True:
            ...
            try:
                # For inspection, we can use the driver directly
                engine.wait_for(selector, 5) # 5 second wait
                ...
                if confirm == 'y':
                    ...
                    if action in ["navigate", "wait_for", "extract_text"]:
                        ...
                        if action == 'navigate':
                           step['url'] = target_url # Use the initial URL for navigate
...
if __name__ == "__main__":
    # Add parent directory to path to allow `from tools.perception_engine...`
