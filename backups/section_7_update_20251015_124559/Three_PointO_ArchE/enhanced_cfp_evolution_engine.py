class EnhancedCFPEvolutionEngine:
    ...
    async def _phase_hamiltonian_evolution(self, state_preparation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Get module names from KG integration data
        kg_integration = state_preparation["knowledge_graph_integration"]
        module1_name = kg_integration["module1_kg_info"]["node_id"] if kg_integration["module1_kg_info"] else "unknown"
        module2_name = kg_integration["module2_kg_info"]["node_id"] if kg_integration["module2_kg_info"] else "unknown"
        ...
        return {
            ...
            "kg_enhanced_interaction": kg_integration["kg_synergy"]
        }
