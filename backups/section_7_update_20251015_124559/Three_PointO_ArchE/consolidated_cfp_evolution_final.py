...
# Test harness
async def main():
    """Test harness for Consolidated CFP Evolution"""
    print("--- Consolidated CFP Evolution Test Harness ---")
    ...
    quantum_simulator = QuantumFluxSimulator(kg_integrator)
    
    # Test basic functionality
    print("\n--- Testing Basic CFP Components ---")
    ...
    state1 = quantum_simulator.prepare_quantum_state(module1_metrics, "Test_Module_1")
    state2 = quantum_simulator.prepare_quantum_state(module2_metrics, "Test_Module_2")
    print(f"State 1 dimensions: {len(state1)}")
    print(f"State 2 dimensions: {len(state2)}")
    
    # Test Hamiltonian construction
    print("Testing Hamiltonian construction...")
    hamiltonian = quantum_simulator.construct_hamiltonian(module1_metrics, "Test_Module_1", module2_metrics, "Test_Module_2")
    print(f"Hamiltonian shape: {hamiltonian.shape}")
    
    # Test quantum evolution
    print("Testing quantum evolution...")
    evolved_state1 = quantum_simulator.evolve_quantum_state(state1, hamiltonian, 5)
    evolved_state2 = quantum_simulator.evolve_quantum_state(state2, hamiltonian, 5)
    print(f"Evolved states: {len(evolved_state1)} time steps")
    
    # Test flux divergence calculation
    print("Testing flux divergence calculation...")
    flux_differences = quantum_simulator.calculate_flux_divergence(evolved_state1, evolved_state2)
    print(f"Flux differences: {len(flux_differences)} values")
    print(f"Average flux: {np.mean(flux_differences):.6f}")
    
    # Test entanglement detection
    print("Testing entanglement detection...")
    entanglement_correlations = quantum_simulator.detect_entanglement(evolved_state1, evolved_state2)
    print(f"Entanglement correlations: {len(entanglement_correlations)} values")
    print(f"Average entanglement: {np.mean(list(entanglement_correlations.values())):.6f}")
    
    # Test emergence analysis
    print("Testing emergence analysis...")
    emergence_patterns = quantum_simulator.analyze_emergence_patterns(flux_differences, entanglement_correlations)
    print(f"Emergence type: {emergence_patterns['type']}")
    print(f"Emergence strength: {emergence_patterns['strength']:.2e}")
    print(f"Amplification factor: {emergence_patterns['amplification_factor']:.2f}")
    
    # Test knowledge graph integration
    print("\n--- Testing Knowledge Graph Integration ---")
    kg_synergy = kg_integrator.calculate_spr_synergy("Test_Module_1", "Test_Module_2")
    print(f"KG Synergy: {kg_synergy:.3f}")
    
    relationships = kg_integrator.find_relationships("Test_Module_1", "Test_Module_2")
    print(f"Relationships found: {len(relationships)}")
    
    capability_overlap = kg_integrator.get_capability_overlap("Test_Module_1", "Test_Module_2")
    print(f"Capability overlap: {len(capability_overlap)} capabilities")
    
    print("\n--- Test Complete ---")
    print("Consolidated CFP Evolution successfully demonstrated!")
    print("All core components working correctly with KG integration.")
