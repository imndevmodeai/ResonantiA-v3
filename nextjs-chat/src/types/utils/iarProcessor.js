...
exports.IARProcessor = void 0;
class IARProcessor {
    /**
     * Process message content and extract/generate IAR data
     */
    static async process(content, context) {
     ...
     */
    static extractExistingIAR(content) {
     ...
     * Generate IAR based on content analysis
     */
    static generateIAR(content, context) {
     ...
     */
    static determineStatus(content) {
     ...
     */
    static calculateTacticalResonance(content) {
        let resonance = 0.5;
     ...
     */
    static calculateCrystallizationPotential(content) {
...
exports.IARProcessor = IARProcessor;
