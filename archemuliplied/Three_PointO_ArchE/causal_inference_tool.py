...
def _prepare_causal_data(data: Union[Dict, pd.DataFrame, List[Dict]]) -> Tuple[Optional[pd.DataFrame], Optional[str]]:
    ...
    try:
        if isinstance(data, list) and all(isinstance(item, dict) for item in data):
            ...
            error_msg = f"Invalid 'data' type: {type(data)}. Expected list of dicts, dict, or DataFrame."
